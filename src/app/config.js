...
=============================================*/
	...
	domain2 = 'http://localhost:4201/src/';
...
Server = {
	...
	url: domain2+'assets/img/index.php?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM',
	delete: domain2+'assets/img/delete.php?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
}
...
Email = {
	...
	url: domain2+'assets/email/index.php?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
...
export let Api = {
	...
	url: 'https://marketplace-ca50e-default-rtdb.firebaseio.com/' // YOUR FIREBASE ENDPOINT
...
export let Register = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
}
...
export let Login = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
}
...
export let SendEmailVerification = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
...
export let ConfirmEmailVerification = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
...
export let GetUserData = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
...
export let VerifyPasswordResetCode = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:resetPassword?key=AIzaSyBWwUC5dFggfB1MtgQYOESpWAw00NQxObM'
